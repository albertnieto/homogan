...
def discriminator_loss(real_output, fake_output):
    smoothed_pos = smooth_pos_and_trick(real_output)
    real_loss = cross_entropy(smoothed_pos, real_output)

    smoothed_neg = smooth_neg_and_trick(fake_output)
    fake_loss = cross_entropy(smoothed_neg, fake_output)
