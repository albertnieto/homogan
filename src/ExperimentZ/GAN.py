...
class Generator(tf.keras.Model):
    def __init__(self, generator_input_shape=(1,1,256)):
        ...
        self.unconv5 = layers.Conv2DTranspose(32, kernel_size=(3,3) ,  strides=(2,2), padding="same", use_bias=False)
        ...
        self.conv2 = layers.Conv2D( 128  , ( 1 , 1 ) , padding='same', name="block_7", use_bias=False)
...
class Discriminator(tf.keras.Model):
    def __init__(self, input_shape, output_shape=1):
        ...
        self.conv1 = layers.Conv2D(16, (5, 5), padding='same', input_shape=[128, 128, 3], name='block1_conv1')
        self.batchNorm1 = layers.BatchNormalization()
        self.leakyRelu1 = layers.LeakyReLU()
        self.dropout1 = layers.Dropout(0.5)

        self.conv3 = layers.Conv2D(32, (3, 3), strides=(2, 2), padding='same', name='block1_conv3')
        self.batchNorm3 = layers.BatchNormalization()
        self.leakyRelu3 = layers.LeakyReLU()
        self.dropout3 = layers.Dropout(0.5)

        self.conv4 = layers.Conv2D(64, (3, 3), strides=(2, 2), padding='same', name='block1_conv4')
        self.batchNorm4 = layers.BatchNormalization()
        self.leakyRelu4 = layers.LeakyReLU()
